...
class Alumno extends Controller
{
    ...
    */
    ...
    /*
        ...
        url asociada: /alumno/editar/id/cssrf_token

        @param int $id: id del alumno a editar
        @param string $csrf_token: token CSRF para evitar ataques CSRF
    ...
    */
    public function update($param = [])
    {
        ...
        // Obtengo el alumno de la base de datos
        ...
        if (!empty($error)) {
            ...
            // redireciona al formulario de nuevo
            header('location:' . URL . 'alumno/editar/' . $id);
            exit();
        }
