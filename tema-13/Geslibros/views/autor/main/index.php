                                    ...
                                    <td>
                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                            ...
                                            <a href="<?= URL ?>autor/editar/<?= $autor->id ?>/<?= $_SESSION["csrf_token"] ?>" title="Editar"
                                                ...
                                                <?= in_array($_SESSION['role_id'], $GLOBALS['autor']['editar'])? null:'disabled'?>"><i class="bi bi-pencil-square"></i></a>
                                            <a href="<?= URL ?>autor/mostrar/<?= $autor->id ?>/<?= $_SESSION["csrf_token"] ?>" title="Mostrar"
                                                class="btn btn-warning
                                                <?= in_array($_SESSION['role_id'], $GLOBALS['autor']['mostrar'])? null:'disabled'?>"><i class="bi bi-eye-fill"></i></a>
                                        </div>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
