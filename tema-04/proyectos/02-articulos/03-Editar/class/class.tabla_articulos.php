...
class Class_tabla_articulos
{
    ...
    */
    ...
    /**
     * metodo create()
     * permite añadir un objeto de la clase articulo a la tabla
     * parametros:
     *           - $articulo - objeto de la clase articulo
     */
     ...
     /**
     * metodo read()
     * permite obtener un objeto de la clase articulo correspondiente a un indice
     * parametros:
