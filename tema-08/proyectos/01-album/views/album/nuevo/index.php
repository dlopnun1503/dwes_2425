            ...
            <div class="card-body">
                ...
                <input type="hidden" name="csrf_token"
                    ...
                    <div class="mb-3">
                        ...
                        id="descripcion" name="descripcion" placeholder="Introduzca descripción" required><?= htmlspecialchars($this->album->descripcion) ?></textarea>
                        <!-- mostrar posible error -->
                        <span class="form-text text-danger" role="alert">
                    ...
                    <div class="mb-3">
                        ...
                        id="autor" name="autor" placeholder="Introduzca autor" value="<?= htmlspecialchars($this->album->autor) ?>" required>
                        <!-- mostrar posible error -->
                        <span class="form-text text-danger" role="alert">
                    ...
                    <div class="mb-3">
                        ...
                        id="lugar" name="lugar" placeholder="Introduzca lugar" value="<?= htmlspecialchars($this->album->lugar) ?>" required>
                        <!-- mostrar posible error -->
                        <span class="form-text text-danger" role="alert">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control <?= (isset($this->error['categoria']))? 'is-invalid': null ?>" 
                        id="categoria" name="categoria" placeholder="Introduzca categoría" value="<?= htmlspecialchars($this->album->categoria) ?>" required>
                        </select>
                        <!-- mostrar posible error -->
                        <span class="form-text text-danger" role="alert">
                    ...
                    <div class="mb-3">
                        ...
                        id="etiquetas" name="etiquetas" placeholder="Introduzca etiquetas" value="<?= htmlspecialchars($this->album->etiquetas) ?>">
                        <!-- mostrar posible error -->
                        <span class="form-text text-danger" role="alert">
                    ...
                    <div class="mb-3">
                        ...
                        id="carpeta" name="carpeta" placeholder="Introduzca carpeta" value="<?= htmlspecialchars($this->album->carpeta) ?>" required>
                        <!-- mostrar posible error -->
                        <span class="form-text text-danger" role="alert">
